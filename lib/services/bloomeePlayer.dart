...
class BloomeeMusicPlayer extends BaseAudioHandler
  ...
  // Jam service for collaborative listening
  ...
  // Jam service getter
  JamService get jamService => _jamService;
  ...
  BloomeeMusicPlayer() {
    ...
    // Initialize Jam service
    _jamService = JamService();
    _jamService.initialize(this);
  }
